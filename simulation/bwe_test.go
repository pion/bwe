...
func TestMain(m *testing.M) {
	...
	if err := os.Setenv("PION_LOG_TRACE", "bwe_send_side_controller,bwe_delay_rate_controller,bwe_test_peer,perfect_codec,ccfb_interceptor,bwe_arrival_group_accumulator"); err != nil {
